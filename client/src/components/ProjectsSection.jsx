...
function ProjectSection({reference}) {
    ...
    const [isWeatherApp, setIsWeatherApp] = useState(false);
        ...
        <div ref={reference} className='projects-section'>
            ...
            <div className='projects-container'>
                ...
                <ProjectCard 
                    ...
                    description="A webpage done using React. A small project done for demonstrating my skills with web development.
                    Users can select a city and view the weather there. The front-end is served using express."
                    setIsOpen={setIsWeatherApp}
                    isOpen={isWeatherApp}
